...
def main():
    ...
    print(f"1) ПОНИМАНИЕ невиданных формулировок (held-out, {len(test)} команд): {acc_test * 100:.0f}%")
    ...
    print("\n── Итог ──")
    print("   Цель задаётся словами. Агент понимает команду (обобщает на невиданные")
    print("   формулировки), грунтит её в пространственную цель и достигает её действием —")
    print("   связка ЯЗЫК → ЦЕЛЬ → ПОВЕДЕНИЕ.")
