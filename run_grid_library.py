...
абстрагирует их в новые именованные операции. Демонстрация СИНТЕТИЧЕСКАЯ (рукотворные
сетки; данные ARC в репозиторий не входят): комбо вроде «bbox ▸ fractal» и
«trim_border ▸ mirror_quad» — это тип преобразований, встречающихся и на ARC.
...
def main():
    ...
    print("   назвала. Комбо такого типа встречаются и на ARC (демонстрация синтетическая —")
    print("   данные ARC в репозиторий не входят).")
