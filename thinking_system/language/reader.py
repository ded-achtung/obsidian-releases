...
ГРАНИЦЫ (без прикрас): это извлечение по ФИКСИРОВАННЫМ шаблонам над ЗАКРЫТЫМ словарём,
а не понимание смысла. Срабатывает только на форму «слово [список] = [список]» с
разделителем из _SEP; перефраз, синоним, другой падеж или иной порядок слов молча
дают None. «Смысл» здесь = «токен есть в словаре функций», не семантический разбор.
"""
