...
def main() -> None:
    ...
    print("   карты переживают процесс. ПЕРЕНОС МЕЖДУ МИРАМИ: решённые миры — тренажёр")
    print("   кросс-мирового навыка (механизм run_transfer), подцель навыка агент")
    print("   выучивает из жизни; на новых мирах навык делает беглый взгляд")
    print("   достаточным там, где агент с нуля барахтается. Границы: подцель навыка")
    print("   одна (цель прежних миров), миры чужой цели/размера навык честно")
    print("   пропускает; лабиринты игрушечные (7×7, полная наблюдаемость).")
