...
def main() -> None:
    ...
    print("   агент возвращается по собственной повестке. Переменные в языке: цвет")
    print("   связывается из палитры задачи (keep/drop/paint) во всех ступенях поиска;")
    print("   шаблоны с дыркой анти-унифицируются из накопленных решений и пробуются")
    print("   после лестницы — им нужны РАЗНООБРАЗНЫЕ глубокие решения, пока их мало.")
